...
This doesn't mean that `confusion` avoids platform-specific utilities for you though, it just means that they aren't included by default. If you find that `confusion` doesn't have support for your specific runtime, you are welcome to open an issue or PR for it!
...
A task scheduler interface is required if you intend on using `observe`, animations or anything within the `async` module.
